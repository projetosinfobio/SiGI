...
<?php
	...
	if(isset($_POST["nome_us"])){*/
		$sql_proj_andamento = "SELECT nome_proj FROM projeto WHERE dta_fim_proj IS NULL;";
		
		
		$select_proj_andamento = mysqli_query($conexao, $sql_proj_andamento);
        //echo $acesso;
        if(!$select_proj_andamento){
...
<head>
    ...
    <title>SiGI - Projetos em Andamento</title>
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                ...
                <div style="text-align: center">
                    <hr2>Em andamento</hr2>
                </div>
                <div class="container-fluid">
                	<?php while($proj_andamento = mysqli_fetch_assoc($select_proj_andamento)) {?>
                    <!-- Content Row -->
                        ...
                        <div class="col-xl-3 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2" style="max-width: 180px">
                                <div class="card-body" style="padding: 0.8rem !important;">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> <?php echo $proj_andamento["nome_proj"]; ?> 
                                        </div>
                                    </div>
                                </div>
                            </div>
