<!-- PHPBemol <?php require_once("conexao.php"); ?>
<?php
    //adicionar variaveis de sessao
    /*session_start();
    $Nro_USP = $_SESSION["Nro_USP"];
    if(isset($_POST["nome_us"])){*/
        $sql_proj_finalizado = "SELECT nome_proj FROM projeto WHERE dta_fim_proj IS NOT NULL;";
        
        
        $select_proj_finalizado = mysqli_query($conexao, $sql_proj_finalizado);
        //echo $acesso;
        if(!$select_proj_finalizado){
...
<head>
    ...
    <title>SiGI - Projetos Finalizados</title>
    ...
    <link href="css/sb-admin-2_maco.css" rel="stylesheet">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.html">
                    ...
                    <span style="margin: 1rem">Em andamento</span>
                </a>
            </li>
            <!--
        ...
        Interface
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    ...
                    <span style="margin: 1rem">Finalizados</span>
                </a>
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                <a class="nav-link" href="charts.html">
                    ...
                    <span style="margin: 1rem">Documentos</span>
                </a>
            </li>
        ...
        <a class="nav-link" href="tables.html">
          ...
          <span>Tables</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="charts.html">
                    <!--<i class="fas fa-fw fa-chart-area"></i>-->
                    <span style="margin: 1rem">Membros</span>
                </a>
            </li>
            <hr class="sidebar-divider d-none d-md-block">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                    ...
                    <span style="margin: 1rem">Atas</span>
                </a>
...
<!-- PHPBemol       <?php while($proj_finalizado = mysqli_fetch_assoc($select_proj_finalizado)) {?>   -->
                    <!-- Content Row -->
                    <div class="row" style="float: left">
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-3 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2" style="max-width: 180px">
                                <div class="card-body" style="padding: 0.8rem !important;">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> <?php echo $proj_finalizado["nome_proj"]; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
